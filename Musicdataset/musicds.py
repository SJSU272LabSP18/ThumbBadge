...
For this one we built the  hadoop cluster , added the datasets to that cluster
The data is loaded into HDFS using hadoop fs -mkdir and hdfs cp comamnds which
...
python prog musicds.py extract and display the required result i.e  top ten song using spark
